            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="data_tugas.php">
                                <i class="fa-solid fa-folder-open mr-4"></i>
                                Data Tugas <span class="sr-only">(current)</span>
                            </a>
                        </li>   
                    </ul>
                </div>
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="row">
                    ...
                    <div class="col col-lg-2 mt-4 mx-4">
                        <a href="upload_tugas.php" class="btn btn-warning"><i class="fa-solid fa-upload"></i></a>
                    </div>
                </div>
                <div class="container mt-3" style="width: 75%;">
                            ...
                            <?php foreach($data as $dt): ?>
                                <tr>
                                    ...
                                    <td style="width: 100px;">
                                        <a href="download.php?file=<?= $dt['nama']; ?>" class="btn btn-primary btn-sm"><i class="fa-solid fa-download"></i></a>
                                        <a href="delete_file.php?file=<?= $dt['nama']; ?>" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    ...
                    <?php else : ?>
                        <div class="alert alert-info" role="alert">
                            <h4><center>Data kosong!</center></h4>
                        </div>
                    <?php endif; ?>
                </div>
            </main>
