    ...
    <div class="container-fuild">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-center flex-wrap flex-md-nowrap align-items-center pt-4 pb-2 mx-4">
                        ...
                        <tbody>
                            <?php foreach($mahasiswa as $mhs): ?>
                                <tr>
                                    ...
                                    <td style="width: 200px"><?= $mhs['nrp']; ?></td>
                                    <td><?= $mhs['nama']; ?></td>
                                    <td style="width: 100px;">
                                        <a href="detail_mahasiswa.php?nrp=<?= $mhs['nrp']; ?>" class="btn btn-primary btn-sm"><i class="fa-solid fa-eye"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
